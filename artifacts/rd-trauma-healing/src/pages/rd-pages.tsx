...
const services: Service[] = [
  ...
  { title: 'Complex trauma', summary: 'Support for the long after-effects of experiences that shaped how you see yourself and others.', detail: 'This work is paced, relational, and rooted in compassion. We focus on safety in the present as well as healing the experiences that made safety difficult.', icon: ShieldCheck, accent: 'bg-[#7D6485]/15' },
...
const testimonials = [
  { initials: 'AM', text: 'I stopped feeling like I had to make my story sound reasonable. Rebecca gave me room to be honest, then helped me find a way through.', detail: 'Trauma-informed therapy · 2024' },
  { initials: 'JL', text: 'The pace was the biggest difference. Nothing was pushed, and somehow I started doing the brave things I had been waiting for.', detail: 'Trauma-informed therapy · 2024' },
  { initials: 'SK', text: 'I understand my body now with much more kindness. The tools are simple, but they have changed the way I move through difficult days.', detail: 'Somatic support · 2025' },
  { initials: 'RB', text: 'I had tried therapy twice before. This was the first time I felt listened to rather than assessed.', detail: 'Online therapy · 2025' },
];
